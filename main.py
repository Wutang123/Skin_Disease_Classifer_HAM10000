...
def main():
    ...
    parser.add_argument('--epoch'      ,  type = int  , default = 50      , help = 'Select Epoch Size (e.g 80)')
    ...
    parser.add_argument('--model'      ,  type = str  , default = 'efficientnet_b0'     , help = 'alexnet, vgg16, resnet50, squeezenet1_1, shufflenet_v2_x1_0, mobilenet_v2, efficientnet_b0')
